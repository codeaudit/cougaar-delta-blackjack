...
set MYPROPERTIES=%MYDOMAINS% -Dorg.cougaar.install.path=%COUGAAR_INSTALL_PATH% -Ddelta.plugin.properties=%COUGAAR_INSTALL_PATH%\deltaopen\data\SamplePluginProperties.ini 
